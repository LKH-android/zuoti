...
public class ExamActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        vertifyView = (TextView) findViewById(R.id.chronometer2);
        ...
        final String value = intent.getStringExtra("xueke2");
        timer.start();
        initFile();
        initView();
        initDB();
    ...
    private CountDownTimer timer = new CountDownTimer(300000, 1000) {
        ...
        public void onTick(long millisUntilFinished) {
            vertifyView.setText(formatTime(millisUntilFinished ));
        }

        @Override
        public void onFinish() {
            vertifyView.setEnabled(true);
            new AlertDialog.Builder(ExamActivity.this).setTitle("提示").setMessage("时间到测试结束")
    ...
    private void initView() {
        ...
        mRadioButton[0] = (RadioButton) findViewById(R.id.RadioA1);
        mRadioButton[1] = (RadioButton) findViewById(R.id.RadioB1);
        mRadioButton[2] = (RadioButton) findViewById(R.id.RadioC1);
        mRadioButton[3] = (RadioButton) findViewById(R.id.RadioD1);

        btn_down = (Button) findViewById(R.id.btn_down1);
        btn_up = (Button) findViewById(R.id.btn_up1);

        tv_result = (TextView) findViewById(R.id.tv_result1);

        mRadioGroup = (RadioGroup) findViewById(R.id.mRadioGroup1);
    }
    public List<Question> getQuestion() {
        ...
        //执行sql语句
        Cursor cursor = db.rawQuery("select * from question where Field9=?", new String[]{intent.getStringExtra("xueke2")});
        if (cursor.getCount() > 0) {
            cursor.moveToFirst();//指向查询结果的第一个位置。
            int count = cursor.getCount();
            //遍历
            for (int i = 0; i < count; i++) {
                cursor.moveToPosition(i);//移动到指定行
        ...
        btn_down.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (corrent < count - 1) {
                    ...
                    new AlertDialog.Builder(ExamActivity.this).setTitle("提示").setMessage("已经到达最后一道题，是否退出？")
                            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    Intent intent = new Intent();
                    ...
                    if (wrongList.size() == 0) {
                        new AlertDialog.Builder(ExamActivity.this).setTitle("提示").setMessage("你好厉害，答对了所有题！")
                                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        Intent intent1 = new Intent();
                                        intent1.setClass(ExamActivity.this, MainActivity.class);
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                intent2.setClass(ExamActivity.this, MainActivity.class);
                    ...
                    //窗口提示
                    new AlertDialog.Builder(ExamActivity.this).setTitle("恭喜，答题完成！")
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                new AlertDialog.Builder(ExamActivity.this).setTitle("提示").setMessage("确认退出测试？")
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Intent intent = new Intent();
